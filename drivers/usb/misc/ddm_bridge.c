...
static void ddm_bridge_read_cb(struct urb *urb)
{
	...
	pr_info("[DDM_BRIDGE][%s] actual_length = %d\n", __func__, urb->actual_length );
#endif
//[2014-01-21] donggee.im : Process non zero length packet while unlinking URB
